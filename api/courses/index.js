...
// Enroll in a course
app.post('/:id/enroll', authenticateToken, async (req, res) => {
  try {
...
app.put('/:id/progress', authenticateToken, async (req, res) => {
  const { id } = req.params;
...
app.post('/:id/enroll-student', authenticateToken, requireRole(['tutor', 'admin']), async (req, res) => {
  const { id } = req.params;
...
app.get('/:id/enrollments', authenticateToken, requireRole(['tutor', 'admin']), async (req, res) => {
  const { id } = req.params;
...
app.delete('/:id/enroll-student/:studentId', authenticateToken, requireRole(['tutor', 'admin']), async (req, res) => {
...
app.post('/:id/notes', authenticateToken, requireRole(['tutor', 'admin']), async (req, res) => {
  const { id } = req.params;
...
app.get('/:id/notes', authenticateToken, async (req, res) => {
  const { id } = req.params;
...
app.put('/:id/notes/:noteId', authenticateToken, requireRole(['tutor', 'admin']), async (req, res) => {
...
app.delete('/:id/notes/:noteId', authenticateToken, requireRole(['tutor', 'admin']), async (req, res) => {
  const { id, noteId } = req.params;
...
app.delete('/:id/unenroll', authenticateToken, async (req, res) => {
  const { id } = req.params;
