const COURSE_SLUGS = {
    'python': { courseId: 2, name: 'Programming with Python', category: 'Programming' },
    ...
    'web-dev-1': { courseId: 9, name: 'Web Development Level 1', category: 'Web Development' },
    'web-dev-2': { courseId: 10, name: 'Web Development Level 2', category: 'Web Development' },
    'web-dev-3': { courseId: 11, name: 'Web Development Level 3', category: 'Web Development' },
